...
public class TestData {
    ...
    public static Movie getTestMovie() {
        if (movie == null) {
            movie = Objects.requireNonNull(parseMovies()).get(0);
        }
        return movie;
    }

    private static List<Movie> parseMovies() {
        try {
            return Parser.parseMovies(moviesJSON);
    ...
    public static final String moviesJSON =
            "{\n" +
                    "  \"page\": 1,\n" +
                    "  \"total_results\": 20008,\n" +
                    "  \"total_pages\": 1001,\n" +
